...
export default function Enquiry()
{
         ...
         const validate = (values) => {
              ...
              if(! values.name.match('[A-Za-z ]+') )
                   errors.name = "names shud contain only alphabets";
         ...
         const onSubmit = (values, {resetForm}) => {
              ...
              let urladd = "https://enquiryappbe28june23-chwbwg8v1-ganeshwadkar25.vercel.app/save";
         ...
         <br/><br/>
         <textarea name="query" placeholder="enter ur query" rows={5} cols={30} onChange={formik.handleChange} onBlur={formik.handleBlur} value={formik.values.query}></textarea>
